...
FlowLab is a browser-based flowchart programming environment for building, validating, stepping through, and running visual programs with functions, classes, objects, loops, input queues, output, text utilities, and turtle graphics.
...
- Imports from FlowLab JSON programs, native text utilities, and turtle graphics.
...
| [Imports and native libraries](docs/imports-and-libraries.md) | JSON program imports plus the `text` and `turtle` libraries. |
